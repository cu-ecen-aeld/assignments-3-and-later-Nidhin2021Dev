...
void test_validate_my_username()
{
     ...
     */
     const char * testOutPut = my_username();
     char * retValue = malloc_username_from_conf_file();
    TEST_ASSERT_EQUAL_STRING_MESSAGE(testOutPut,retValue,"Username validation Test Passed");
}
